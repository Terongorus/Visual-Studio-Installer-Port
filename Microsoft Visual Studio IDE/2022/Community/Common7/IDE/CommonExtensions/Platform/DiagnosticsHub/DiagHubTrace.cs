...
#pragma warning disable CA1707, CS3008, SA1300 // Identifiers should not contain underscores
namespace ____DiagHubTrace
#pragma warning restore CA1707, CS3008, SA1300
{
    using System;
    ...
    internal sealed class DiagHubTrace : IDisposable
    {
        ...
        public void InsertMark(ushort id)
        {
            if (this.started)
            {
                Debug.Assert(id >= FirstValidId && id <= MaxValidId, "Invalid ID");
        ...
        private void Initialize()
        {
            ...
            if (NativeMethods.EventRegister(ref localId, IntPtr.Zero, IntPtr.Zero, ref this.regHandle) == DiagHubTrace.SuccessErrorCode)
            {
                this.started = true;
            }
        }
...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
        ...
        private sealed class NativeMethods
        {
            ...
            {
                [FieldOffset(0)] public long DataPointer;
