...
var populateResources = function () {
    var body = document.getElementsByTagName("body")[0];
    var content = body.innerHTML;

    function replaceResource(match) {
        return res(match.substring(6,match.length-2));
    }

    var fixed = content.replace(/\{\{res\:.+?\}\}/g, replaceResource.bind(this));
...
if(typeof plugin != 'undefined'){
    ...
    setTimeout(populateResources, 500);
}

var res = function (key) {
    try {
        return plugin.Resources.getString(key);
    } catch (e) {
        return JSON.stringify("Res: " + key + " [" + e + "]");
    }
};
...
// SIG // kHlA/n1QlPSVFPa/JQ634MglflOpg7aP6HZwEBpY5pag
...
// SIG // DQEJBDEiBCBr/XNvldNLs1GomT1c3eafefxrMQE3zPhB
// SIG // ljAKImghxzBCBgorBgEEAYI3AgEMMTQwMqAUgBIATQBp
// SIG // AGMAcgBvAHMAbwBmAHShGoAYaHR0cDovL3d3dy5taWNy
// SIG // b3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAGjxHmnU
// SIG // vBbNFMmKsBSYbiAQ25ulcjU8kODGu80Q2Ieq9guog0ej
// SIG // 225YZvGp3kAYJ6lHMrdU2FT9dVMJLnHSW4EkYksoXceV
// SIG // SUJkYa2FAlz9zyM4ome2EKl+Q3ku0ifvnvFgCTzcuR/q
// SIG // bm/WZ3Cq2FhujC4mhGYCqyxue/Jf0Z82a70L8+8MuStM
// SIG // J8sSVLdPJ0ZhPzK7tAFL4kMPAOa1QDwN2VhV5sCA/Eoh
// SIG // pIOL95JfyeZEQ8TYMjBEw5y3YUdZ1Mvc3fAAr3K4v5Sb
// SIG // 0woDbXy39EJvzvsNvIOE6YmxUF+M1DUmG0zIVup7keJF
// SIG // 8dYxpTpJ9TCvtxW5zO+dZLbjYouhghetMIIXqQYKKwYB
...
// SIG // MTANBglghkgBZQMEAgEFAAQgsV9tGW045VX6ZyDqYyJb
// SIG // R+M78evePuaO7jyPxHmXmM0CBmftJkcgJhgTMjAyNTA0
// SIG // MTUxOTI4MzUuNzE0WjAEgAIB9KCB2aSB1jCB0zELMAkG
// SIG // A1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAO
// SIG // BgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29m
...
// SIG // AQkQAQQwLwYJKoZIhvcNAQkEMSIEIMwB4SUEGzUBzJaa
// SIG // xZCPi+7EXe1bIeOlY3acb1VLbvtnMIH6BgsqhkiG9w0B
...
// SIG // 4hsurlPBg23HpDANBgkqhkiG9w0BAQsFAASCAgBkd0w2
// SIG // 2si0BSXMSij7DMzE0SokTy9YCERp+af2FElyo/CiOxS/
// SIG // 7ujA7rd3zafprjPNN2xNiZ8TWdRvGaNjbZf1gBtrGDc8
// SIG // cBK/EUr8jgFy8UJLKuSm+6JzLOSONuem89wR8ue+4k0b
// SIG // VNNK2fr/lOQ2Ad8p6wZ6waY8eZVSG7+lxSEm9UylUxF+
// SIG // 71gdQvZjLLTWDUEm93xNwCDu78qTv2X2tUO7a6HAvWcT
// SIG // zsa/VcV0W0AUxJnPKPvJDbhPiTgVsM8/FobGNyfPZhs1
// SIG // 0LjcQjyBgn0SLCsBJG0u1yQ6bfmeO/7nUbzbwicfsvZx
// SIG // FmtzjPRyl17sPM8P5/8/bs7H8N2pG0dEgmQrXV4fe5vy
// SIG // Fm0EmaVe54LPxb+AVHhWH+6vTeqjlOProN2Doh+eIxN9
// SIG // fLH5wxRRx/t1/w6tRvZdT4NUmizgwGxpMSBXSI2FzRXo
// SIG // hXGP4FZcETGOfaNhWnISQuzbO+T2/uUAtsBPDsh1+8pH
// SIG // oFRG9RZjSqKLptcVU1iCFapf7R/RXG6FoKKIyCpeTW9N
// SIG // CL9p7LUHrMtHc9OI5pxSuGJ65YX9aS15Kyxzn56mVcM2
// SIG // sOG5ESMECN1vn6164StB80FwNpeIN+Zniunl+oertQvN
// SIG // jwrTO/kmxzf11H0wM26CTiyziHf4RNBacGutytb98EVV
// SIG // nUrfNQpizL7FZ3UAYQ==
