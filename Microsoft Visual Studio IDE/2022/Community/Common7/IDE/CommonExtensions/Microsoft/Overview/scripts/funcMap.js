...
(function () {
    ...
    window.OverviewActions = plugin.JSONMarshaler.attachToMarshaledObject("OverviewActionsObject", {
        openManifest: function () {
            return this._call("OpenManifest");
        },
        log: function (params) {
            return this._call("Log", params);
        },
        openAppServicePage: function () {
            return this._call("OpenAppServicePage");
        },
    }, true);
})();

var openManifestEvent = function (event) {
    window.OverviewActions.openManifest();
    event.preventDefault()
}

var log = function (event) {
    var flattened = redux(event);
    window.OverviewActions.log(JSON.stringify(flattened));
}

var openAppServicePage = function (event){
    window.OverviewActions.openAppServicePage();
    event.preventDefault()    
}
...
// SIG // HH5b26WkCRI2aRRLgIrS6cnjXR4McOgR7Iyoxg/pfCig
...
// SIG // DQEJBDEiBCB9Zby+TUwPwx4J56NXVJu6kTJmdPtM5lVX
// SIG // zgZ1H+/0RDBCBgorBgEEAYI3AgEMMTQwMqAUgBIATQBp
// SIG // AGMAcgBvAHMAbwBmAHShGoAYaHR0cDovL3d3dy5taWNy
// SIG // b3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAIynXrQk
// SIG // APWygP0sorG8MeqiInQXGdfOiN4/bXLXUaW1QnazpigK
// SIG // yjnKai9JFpjlqlNmbLHl3Uq6jzwuTvV0ic7gpl4Dr124
// SIG // 15Opqx6WBtnQ8IBfBD4IUWAE2aWvMmoiiM08FnRz3dlj
// SIG // WwEvXKBLWY0dThLJhJxrL4VYi3z0xANhPKMaQmCBxYjD
// SIG // paMEnSWRKTntboFlVs5c5z9hHw/wbwwvNTXOc/1FQHXX
// SIG // H9P9KOKbyLzwdYP8bqCxvHHi6uZ2ovXeM3zrP+FX9YCU
// SIG // zbLkBBAJ/sq8VCK8s+lOymx6Ze/NKlTraIFOjLEn67s6
// SIG // 8Vy6+/gL1sgeahoAlX/twG7MyZGhghewMIIXrAYKKwYB
...
// SIG // MTANBglghkgBZQMEAgEFAAQgD9Rrmp1LLi1/fUMQKtiB
// SIG // w0FCXw+c/DmZ5gz7fzis/1gCBmftLaStYxgTMjAyNTA0
// SIG // MTUxOTI3MzguNTQ0WjAEgAIB9KCB2aSB1jCB0zELMAkG
// SIG // A1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAO
// SIG // BgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29m
...
// SIG // hvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIGwoDCeNjT3I
// SIG // b1PF/OSRegYjZ5zdU+xQlbUgFXWtoQXmMIH6BgsqhkiG
...
// SIG // IByDZ5+W8NXJT4QWbjANBgkqhkiG9w0BAQsFAASCAgBs
// SIG // 4LiT5XJDW90I+yETCeolPQeOJJD1ftz8tCp4/Q3wAtHe
// SIG // Gr+FGAjjU/rIONoOsbJXIWNYZ47sDoj5ZFNcomi7u3Bd
// SIG // Q6IHR4DBYGWgmKURSiIwA5Yuk87UCQQavAFERGjqiHov
// SIG // 8I4IM+hlRV5et2DARlSej/V3//j7ZHF/jKJY9YXTZScP
// SIG // Y8o3ZdP9sPhI8NV1SVXZHsfhxKW7rvHYwQlMP/F4Daj+
// SIG // w9YRkzSy3eVdGR9CklLxgQZiVurisjuTmfspNlmSd7Jo
// SIG // A4Coj4vZWbaPchjU8D/sD4gBzu6U0XdHntMMz/RAlR8N
// SIG // jF5wOXP8u+rAq8bC56oj179VDrXs8q/qNDdkylcJPhxP
// SIG // avc7Werui3FI5IQr/ZHg2SONY5IU60Zm13bg4ClTOK6+
// SIG // +Q+S2IUh586roz8xbY54t+7dQknME/22RPAd5kr3NAyc
// SIG // vnLTYLGZbWPihaX+xJQ8PTCFAm5/sTy75phqoreOAUOs
// SIG // SruebvWthbxiyONvRRTUUHENPIzZOj4J47PA2tENR3MH
// SIG // msjOFqyfj1SdVQJstkyCmJPQFjcQYN5HETswl5gxbgTP
// SIG // q6H9T1xlGPYEonoCXcMO0eSJxH0N8eRF0McEhsrLuRzF
// SIG // VRwgRqbWaaQPZGUSohukheGvhcy60d4gAUiAFR5ESjTh
// SIG // suySkhLVl7moxxvfMy91xQ==
