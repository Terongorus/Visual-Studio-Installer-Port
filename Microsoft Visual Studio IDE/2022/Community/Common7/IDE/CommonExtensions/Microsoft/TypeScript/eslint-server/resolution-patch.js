// This module is meant to be used in node invocations executed automatically by VS.
// It prevents automatic and unintended loading of modules from the root of a Windows
// drive, which is world - writable and can thus lead to privilege escalation.
// For example, one could create `C:\node_modules\eslint.js`, and if `eslint` isn't already
// installed in a given project, the `eslintServer.js`'s lookup would unintentionally execute
// that script instead, regardless of its contents.
//
// To use this modules, take any normal node invocation, and add `-r path/to/resolution-patch.js`
// as an argument, before the script to be executed.
// e.g. `node -r path/to/resolution-patch.js path/to/eslintServer.js`
const Module = require("module");
const fs = require("fs");
const path = require("path");
const child_process = require("child_process");
const VOLUME_STATS = volumeStats();
...
function isSafePath(p) {
  try {
    const stat = fs.statSync(path.dirname(fs.realpathSync(p)));
    return VOLUME_STATS.every(root => root.ino !== stat.ino);
  } catch {
    return true;
  }
}
...
function getAllVolumes() {
  return [...child_process.execSync("gdr -PSProvider 'FileSystem' | select name", {
    shell: "powershell",
    encoding: 'utf8'
  }).matchAll(/^([a-zA-Z])[\s\r\n]/gm)].map(x => x[1] + ":\\");
}
...
// SIG // VN7ida4+PGKEwbHcUanfxJskYN0BfH8NENUnXZTA7lWg
...
// SIG // AYI3AgEVMC8GCSqGSIb3DQEJBDEiBCD1X+r7kocdinfR
// SIG // ASMZ3eoHIqo8poTuTcdNQOtVuuPZkTBCBgorBgEEAYI3
// SIG // AgEMMTQwMqAUgBIATQBpAGMAcgBvAHMAbwBmAHShGoAY
// SIG // aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3
// SIG // DQEBAQUABIIBAAgB+zG3fpJJWJ2r+pQ+Ii0BOfgAWzp3
// SIG // UK+wGSLV8y6nS1IV6vWNSN7cDdEYTZRzDsd+URD84+Dp
// SIG // rIQupLOd4fiwF+psu1sCVBszrkyVciNvm7n2AgBZoAJm
// SIG // bOybI7Npm0J+rGz3mXB3Fmrs75T3V3vOin0l16cafFdS
// SIG // gJ7swANuqzP07hsfBq1dWKDl8EFzoMBMjNmVV0Q3eOzB
// SIG // 8keOcVXXl8c+koeO/B1Ne7L4oEuLopsHuEFO2pZMiC+y
// SIG // vzggnF5wczqc+lExF8PxSkJrHL8jHtiJvAOXbzFGKXZu
// SIG // 4YpyN9SFsg5/NmoGOVZTgxq14MYt/eXjRVQDPZNTvq3Z
// SIG // 4ZWhghetMIIXqQYKKwYBBAGCNwMDATGCF5kwgheVBgkq
// SIG // hkiG9w0BBwKggheGMIIXggIBAzEPMA0GCWCGSAFlAwQC
// SIG // AQUAMIIBWgYLKoZIhvcNAQkQAQSgggFJBIIBRTCCAUEC
// SIG // AQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQg
// SIG // gBBmsxk8z3UG+qq2MCMRzoV/qLHPE2vowIZH/zqlk7MC
// SIG // BmgSxpbypxgTMjAyNTA1MDIxOTE1MDcuMjYxWjAEgAIB
...
// SIG // BQACBQDrvz85MCIYDzIwMjUwNTAyMTI1NTIxWhgPMjAy
// SIG // NTA1MDMxMjU1MjFaMHQwOgYKKwYBBAGEWQoEATEsMCow
// SIG // CgIFAOu/PzkCAQAwBwIBAAICKH0wBwIBAAICEzswCgIF
// SIG // AOvAkLkCAQAwNgYKKwYBBAGEWQoEAjEoMCYwDAYKKwYB
// SIG // BAGEWQoDAqAKMAgCAQACAwehIKEKMAgCAQACAwGGoDAN
