...
namespace Microsoft{ namespace VisualStudio {namespace CppUnitTestFramework
{
	...
	template <typename Q> constexpr bool dependent_false = false;
	template <typename Q> static std::wstring ToString(const Q& q) { static_assert(dependent_false<Q>, "Test writer must define specialization of ToString<const Q& q> for your class " __FUNCSIG__ "."); }
	template <typename Q> static std::wstring ToString(const Q* q) { static_assert(dependent_false<Q>, "Test writer must define specialization of ToString<const Q* q> for your class " __FUNCSIG__ "."); }
	template <typename Q> static std::wstring ToString(Q* q)       { static_assert(dependent_false<Q>, "Test writer must define specialization of ToString<Q* q> for your class " __FUNCSIG__ "."); }
